...
\paragraph{} A Figura \ref{fig:152} apresenta indicadores de performance para valores de \begin{math} C_{max} \end{math}, \begin{math} \sigma_s \end{math} e \begin{math} \sigma_e \end{math}. Foram utilizados na simulação os 71 \textit{tickers} indicados na Tabela \ref{tab:5} no intervalo de 01/01/2019 a 31/12/2021. O gráfico mostra que ...
