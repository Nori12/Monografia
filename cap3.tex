...
\begin{itemize}
    ...
    \item Diminuição do tráfego na rede por causa da persistência dos \textit{candlesticks} já obtidos.
\end{itemize}
...
\paragraph{} A figura \ref{fig:103} mostra o ERD\footnote{\textit{Entity-Relationship Diagram}. Em português: Diagrama de Entidade Relacionamento.} do banco. O \textit{script} de criação e população inicial do banco de dados pode ser encontrado em \cite{github_projeto}.
