...
\paragraph{} Na tentativa de encontrar o valor bem ajustado para o Período Máximo de Dias, uma simulação com o intervalo de 10 a 80 dias foi executado para os 71 \textit{tickers} da tabela \ref{tab:5} para o intervalo de 01/01/2019 a 31/12/2021. Utilizou-se um RCC baixo para evitar saturação de capital e nenhuma otimização. A Figura \ref{fig:740} mostra os resultados obtidos.

\begin{figure}[!htb]
    \includegraphics[scale=0.40]{no_image.jpeg}
    \centering
...
\begin{figure}[!htb]
    \includegraphics[scale=0.75]{performance_per_op_risks.png}
    \centering
