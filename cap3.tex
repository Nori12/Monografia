...
\begin{center}
    ...
    \begin{longtable}[m]{| m{11em} | m{21em} |}
        ...
        \hline
        dynamic\_rcc\_k & Valor do ganho proporcional K no controle do RCC dinâmico (Seção \ref{sub:dynamic_rcc}). Tipo: \textit{Float}. \textit{Default}: 5. Listável: Sim. \\
        \hline
